...
const baseURL = isDev ? "http://localhost:1337" : "http://80.87.194.181/api";
...
const Login = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (!username || !password) {
      setUserData(
        Object.assign({}, userData, { error: "Please check your data." })
      );
      return;
    }
    ...
    <Layout>
      <div className="login">
        <form onSubmit={handleSubmit}>
          ...
          <button className="standart" type="submit">
            Login
          </button>
